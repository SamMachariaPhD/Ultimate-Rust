...
* The interest is to handle the object reffered to by such object. The `*` symbol is used to access such object. The position of the object is at the address received in the function argument 
