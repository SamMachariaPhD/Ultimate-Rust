...
* `match` has two parts: the pattern and the code. The `=>` points to the code being matched with. For the case of `Coin::Penny => 1`, the pattern is the `Coin::Penny` and the code is `1`.
