...
* The `match` *coin* looks similar to _if_ or _switch_ expression but can return any type -- not only bolean. In this example, the type is the *Coin* `enum` defined at the begining.
