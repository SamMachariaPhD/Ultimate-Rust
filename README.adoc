...
* The above program works but does not use referencing. The array data is copied when the function is invoked and back to the original stack. This is computationally expensive. The following is a better function. 
